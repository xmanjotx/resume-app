      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-6">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-md px-3 py-2 mb-3 inline-block">
            ...
            <>
              ...
              <div className="p-4 border-t border-gray-200 flex gap-2">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors flex items-center justify-center gap-2 font-medium"
                >
